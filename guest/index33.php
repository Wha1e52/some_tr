...
<div class="container">
    ...
    <?php if (empty($_SESSION['user']['login'])): ?>
        ...
        <form action="index33.php" method="post" class="row g-3">
            <div class="col-md-6 offset-md-3">
    ...
    <?php else: ?>
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <p>Добро пожаловать, <?= htmlspecialchars($_SESSION['user']['login']) ?>! <a href="?do=logout">Log
                        out</a></p>
            </div>
        </div>

        <form action="index33.php" method="post" class="row g-3 mb-5">
            <div class="col-md-6 offset-md-3">
                <div class="form-floating">
    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            ...
            <div class="card my-3">
                <div class="card-body">
                    <h5 class="card-title">Автор: <?= htmlspecialchars($message['login']) ?> </h5>
